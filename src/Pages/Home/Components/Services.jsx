...
const cards = [
  {
    ...
    content: "services-card-content",
    listKey: "services-card-list",
  },
  {
    icon: homeIcon,
    title: "services-card2-title",
    content: "services-card2-content",
    listKey: "services-card2-list",
  },
];
      ...
      <div className="flex flex-col-reverse gap-3 md:flex-row md:justify-between">
        ...
        <div className="relative ">
          ...
          <div className="absolute bg-primary rounded-xl w-[33%] h-[15%] bottom-1 left-2 sm:w-[26%] sm:h-[15%] sm:bottom-1 sm:left-2 md:w-[30%] md:bottom-16 md:left-3 lg:bottom-0 lg:left-1 lg:w-[34%] flex items-center justify-center">
            <p className="text-center  text-2xl sm:text-6xl font-bold text-[rgba(255,255,255,0.25)] -rotate-6 z-10">
              30
            </p>
            <p className="absolute z-20 text-white text-xs sm:text-[16px] md:text-xs lg:text-xl">
              {t("experience-years")}
            </p>
            <img
              src={medal}
              className="relative top-5 left-5 sm:left-[30px] md:left-0 lg:left-[30px] "
            />
          </div>
        </div>
      </div>
